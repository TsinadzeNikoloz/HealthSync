...
export function DeleteAccountCard() {
	...
	return (
		<>
			<div className="rounded-[2.5rem] border border-rose-100 bg-white p-10 shadow-sm">
				...
				<button
					...
					className="rounded-2xl border border-rose-200 bg-rose-50 px-6 py-3 text-sm font-bold text-rose-600 transition-all hover:bg-rose-100"
				>
