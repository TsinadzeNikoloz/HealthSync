      ...
      <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden bg-gradient-to-br from-indigo-950 via-indigo-900 to-indigo-700">
        ...
        <div className="relative z-10 p-20 flex flex-col justify-between h-full w-full">
          ...
          <div className="flex items-center gap-4 bg-white/5 border border-white/10 rounded-2xl p-6">
            ...
            <div>
              <p className="text-white font-bold text-sm">Secure Reset Process</p>
              <p className="text-indigo-200/60 text-xs mt-1 font-medium">Reset links expire in 10 minutes for your security.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md w-full">
          ...
          {sent ? (
            <div className="text-center">
              ...
              <h2 className="text-3xl font-black text-slate-900 mb-3 tracking-tight">Check Your Inbox</h2>
              <p className="text-slate-500 font-medium mb-10">
                If <span className="font-bold text-slate-700">{email}</span> is registered, a reset link is on its way.
              </p>
              <Link
                to="/login"
