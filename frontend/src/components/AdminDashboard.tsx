			...
			<div className="flex flex-col gap-8">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					{[
						...
						<div
							key={kpi.label}
							className="bg-white rounded-[1.5rem] p-6 border border-slate-100 shadow-sm flex items-center gap-4"
						>
							<div
								className={`w-11 h-11 ${kpi.bg} rounded-2xl flex items-center justify-center shrink-0`}
							>
